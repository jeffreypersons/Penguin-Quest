...
namespace PQ.Common
{
    ...
    */
    public class RayCaster
    {
        ...
        public CasterHit? CastBetween(Vector2 from, Vector2 to)
        {
        ...
        public CasterHit? CastFromPoint(Vector2 point, Vector2 direction)
        {
        ...
        public CasterHit? CastFromCollider(Collider2D collider, Vector2 direction)
        {
        ...
        private static CasterHit? Cast(Vector2 origin, Vector2 direction, float distance, LayerMask layerMask)
        {
