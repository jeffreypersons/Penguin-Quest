    ...
    */
    public sealed class RayCasterSegment
    {
        ...
        public RayCasterSegment() :
            this(segmentStart: Vector2.zero, segmentEnd: Vector2.zero, Vector2.right)
        { }

        public RayCasterSegment(Vector2 segmentStart, Vector2 segmentEnd, Vector2 rayDirection)
        {
