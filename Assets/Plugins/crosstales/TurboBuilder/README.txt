...
Please read the "TurboBuilder-doc.pdf" and "TurboBuilder-api.pdf" for more details.

 


## Upgrade to new version
Follow these steps to upgrade your version of "Turbo Builder PRO":

1. Update "Turbo Builder PRO" to the latest version from the "Unity AssetStore"
2. Delete the "Assets/Plugins/crosstales/TurboBuilder" folder from the Project-view
...
* [Homepage](https://www.crosstales.com/en/portfolio/TurboBuilder/)
* [Email](mailto:tpb@crosstales.com)
...
## More information
* [AssetStore](https://assetstore.unity.com/packages/slug/98714?aid=1011lNGT)
* [Forum](https://goo.gl/6Teq3N)
* [Documentation](https://www.crosstales.com/media/data/assets/TurboBuilder/TurboBuilder-doc.pdf)
* [API](https://www.crosstales.com/media/data/assets/TurboBuilder/api/)
